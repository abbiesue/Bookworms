    ...
    <main>
        ...
        <div className="feed" id="dropFirst">
            ...
            <div className="response">
                <div className="responseAuthorContainer"><span className="responseAuthor">You</span> wrote:</div>
                <div className="responseText"> 
                    <details>
                        <summary>
                            "No one could have prepared me for the day I had to kill..."
                        </summary>
                        <div className="fullText"> No one could have prepared me for the day I had to kill my best friend. Wow this is so insightful and tragic and awesome. Aren't I a good writer?</div>
                    </details>
                </div>
